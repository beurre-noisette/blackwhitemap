    ...
    class GetChefs {
        ...
        void getChefs_includesAllFields() {
            ...
            assertAll(
                    ...
                    () -> assertThat(chef.smallAddress()).isEqualTo("강남"),
                    () -> assertThat(chef.latitude()).isEqualTo(36.123456),
                    () -> assertThat(chef.longitude()).isEqualTo(127.654321),
                    () -> assertThat(chef.closedDays()).isEqualTo("월, 일"),
